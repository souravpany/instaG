...
import com.android.own.instag.di.component.DaggerViewHolderComponent
import com.android.own.instag.di.component.ViewHolderComponent
import com.android.own.instag.utils.display.Toaster
...
abstract class BaseItemViewHolder<T : Any, VM : BaseItemViewModel<T>>(
    ...
    private fun buildViewHolderComponent() =
        DaggerViewHolderComponent
            .builder()
            .applicationComponent((itemView.context.applicationContext as InStaGApplication).applicationComponent)
